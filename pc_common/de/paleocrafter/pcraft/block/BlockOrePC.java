...
import de.paleocrafter.pcraft.block.tileentity.TileEntityFossile;
...
public class BlockOrePC extends Block {
    ...
    public void registerIcons(IconRegister iconRegister) {
        fosFront = iconRegister.registerIcon(Reference.MOD_ID
                .toLowerCase() + ":fossileFront");
        fosSides = iconRegister.registerIcon(Reference.MOD_ID
                .toLowerCase() + ":fossileSides");
        ammonite = iconRegister.registerIcon(Reference.MOD_ID
                .toLowerCase() + ":ammoniteBlock");
    }
